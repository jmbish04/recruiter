/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0d5a6e2f913f8bb686d679ceade97389)
...
declare namespace Cloudflare {
	interface Env {
		...
		CLOUDFLARE_WORKER_NAME: "recruiter";
		USE_OPENAI_MODELS: true;
		AI_GATEWAY_NAME: "job-hunt";
		SCRAPER_AGENT: DurableObjectNamespace /* ScraperAgent */;
		EVALUATOR_AGENT: DurableObjectNamespace /* EvaluatorAgent */;
		WRITER_AGENT: DurableObjectNamespace /* WriterAgent */;
		AGENT_JULES_FEEDBACK: DurableObjectNamespace /* JulesFeedbackAgent */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OWNER" | "CLOUDFLARE_WORKER_NAME" | "USE_OPENAI_MODELS" | "AI_GATEWAY_NAME">> {}
}
