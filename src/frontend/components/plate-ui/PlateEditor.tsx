  ...
  return (
    <div className="w-full h-full flex flex-col border border-border rounded-md bg-card">
      <div className="flex justify-start gap-1 p-2 bg-muted/50 border-b border-border">
        <button onClick={() => handleFormat('bold')} className="px-3 py-1 hover:bg-muted rounded text-sm font-bold">B</button>
        <button onClick={() => handleFormat('italic')} className="px-3 py-1 hover:bg-muted rounded text-sm italic">I</button>
        <button onClick={() => handleFormat('underline')} className="px-3 py-1 hover:bg-muted rounded text-sm underline">U</button>
      </div>
